...
export default function Journal() {
    ...
    return (
        <LinearGradient
            colors={['#f8f7f6', '#eef2ff']} // Soft Gradient: Off-white -> Light Indigo
            style={{ flex: 1 }}
        >
            <SafeAreaView className="flex-1">
                <View className="flex-row items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100/50">
                    <View>
